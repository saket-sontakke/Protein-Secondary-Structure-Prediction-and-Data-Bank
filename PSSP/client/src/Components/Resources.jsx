  ...
  return (
    <div className='resources-container'>
      ...
      <section className='model-info'>
        ...
        <br /><br />For more details, you may check out the published paper <a href="https://thegrenze.com/index.php?display=page&view=journalabstract&absid=5860&id=8" target="_blank" rel="noopener noreferrer">here</a>. 
        </p>
      </section>
