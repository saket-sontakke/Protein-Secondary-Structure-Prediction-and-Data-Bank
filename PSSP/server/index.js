...
// 2. ROBUST DATABASE CONNECTION (The Fix)
...
const connectToDatabase = async () => {
    ...
    try {
        ...
        throw new Error('Database connection failed'); // This will trigger the 500 error in the route
    }
};
...
app.get('/databank-head', async (req, res) => {
    try {
        await connectToDatabase(); // <--- WAIT for DB here
...
app.get('/databank/:pdb_id', async (req, res) => {
    try {
        ...
        // Trim whitespace just in case user input has spaces
...
app.get('/fulldataset', async (req, res) => {
    try {
        ...
        // Note: We return { data: [...] } to match your frontend expectation
